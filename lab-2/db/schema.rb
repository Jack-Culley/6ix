...
ActiveRecord::Schema.define(version: 20_220_311_225_021) do
  ...
  create_table 'courses_users', id: false, force: :cascade do |t|
    ...
    t.boolean 'interest'
    t.index %w[course_id user_id], name: 'index_courses_users_on_course_id_and_user_id'
    t.index %w[user_id course_id], name: 'index_courses_users_on_user_id_and_course_id'
  end
